...
const CodeBlock = ({ children }) => (
  <pre className="relative overflow-x-auto rounded-lg border border-red-400/20 bg-black/70 p-4 text-red-300">
    ...
    <section id="cli" className="pb-16 md:pb-24">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="rounded-xl border border-red-400/20 bg-zinc-900/60 p-6">
          ...
          <div className="rounded-xl border border-red-400/20 bg-gradient-to-b from-red-500/10 to-red-500/5 p-6">
            ...
            <div className="mt-4 rounded-lg border border-red-400/20 bg-black/60 p-4 text-sm text-zinc-300">
              <p className="font-medium text-red-300">Sample JSON</p>
              <pre className="mt-2 overflow-x-auto text-rose-200">{`
{
  "provider": "openai",
  "model": "gpt-4o-mini",
  "tokens_in": 1203,
